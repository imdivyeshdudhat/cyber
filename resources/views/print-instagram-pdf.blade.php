...
<head>
    ...
    <style>
        ...
        Mota Bazar,
        Navsari – 396445,
        Gujarat<br>Ph.+91 6359626594 / Email ID: pi-cyber-nav@gujarat.gov.in </p></td></tr></table><div class="container"><div class="header"><div style="float: left;">Outward No: {{ $case->outward_no }}/2025</div><div style="float: right;">Date: {{ date('d/m/Y') }}</div></div><div class="notice-title">Notice U/S 94 of BNSS 2023</div><div>To, <br>Meta Platforms, Inc.<br>1 Meta way, Menlo Park, CA 94025. </div><div style="margin-top: 15px; text-align: center;"><strong class="notice-title">Sub: Request for Information regarding Instagram Profile</strong></div><div style="margin-top: 15px;">Complaint No. <strong>{{ $case->acknowledgement_no }}</strong>has been registered at the Cyber Crime Police Station Navsari. During the inquiry, we found an Instagram profile involved in fraudulent activity. </div><table class="table"><thead><tr><th>Instagram ID</th></tr></thead><tbody><tr><td>{!! $case->remarks !!}</td></tr></tbody></table><div>You are requested to provide below mentioned details of the above Instagram profile: <ol><li>Complete profile information (including name, username, bio, profile picture history).</li><li>Account creation date and associated email address(es) and phone number(s).</li><li>Login history with IP addresses, dates, and times.</li><li>Associated Facebook account (if any).</li><li>List of followers and following.</li><li>Posts, stories, reels, and archived content.</li><li>Direct messages and comments.</li><li>Any linked payment information or transaction history.</li><li>Any other important information you have regarding this profile.</li></ol></div><div class="note"><strong>Note-</strong><ol><li>Please provide the Nodal Officer's name, email id, and mobile number immediately.</li>
