...
Ph. +91 6359626594 / Email ID: pi-cyber-nav@gujarat.gov.in
            ...
            <div class="container">
                ...
                <div style="margin-top: 15px;">
                    ...
                    During the inquiry, we found some bank accounts in which some fraud transactions has been done.
                </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>{{ $case->account_id }} - {{ $case->transaction_id_2 }}</td>
                            <td>{{ $case->ifsc_code }}</td>
                        </tr>
                    </tbody>
                </table>
